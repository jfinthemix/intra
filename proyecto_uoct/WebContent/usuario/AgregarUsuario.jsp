...
<h2>Agregar usuario</h2>
				 		...
				 		<div class="box boxpost">
				 			...
				 			<form id="formAgregarUsuario" name="form1" method="post" action="usuarioAction.do" class="form-horizontal">
				 			<input type="hidden" name="hacia" value="nuevoUsuario" />
  								<div class="form-group">
    								<label for="inputNombre"  class="col-sm-4 control-label">Nombre*</label>
    								<div class="col-sm-8">
      								<input name="nombre_usu" maxlength="20"   type="text" class="form-control" id="inputNombre">
    								</div>
  								</div>
  								<div class="form-group">
    								<label for="inputNombreDos" class="col-sm-4 control-label">Segundo nombre</label>
    								<div class="col-sm-8">
      								<input name="nombre2_usu" maxlength="20" type="text" class="form-control" id="inputNombreDos">
    								</div>
  								</div>
  								<div class="form-group">
  								...
  								<div class="form-group">
    								...
    								<div class="col-sm-8">
      								<input type="text" maxlength="15" name="username" class="form-control" id="inputUsername">
    								</div>
  								</div>
  								<div class="form-group">
    								<label for="inputPass" class="col-sm-4 control-label">Password*</label>
    								<div class="col-sm-8">
      								<input type="password" maxlength="15" name="password" class="form-control" id="inputPass">
    								</div>
  								</div>
  								<div class="form-group">
   ...
   while (ip.hasNext()){
    ...
    %>
  								...
  								<div class="boxOpciones">
    								<div class="form-group">
    									<div class="col-sm-offset-2 col-sm-10">
      									<a href="javascript:submitThisformAgregarUsuario()" type="submit" class="botoVerde">Registrar usuario</a>
    									</div>
  									</div>
    							</div>
  							</form>
				 		...
				 		<div class="verMas">
							...
							<a href="javascript:linkAyuda()" class="pull-right"><span class="glyphicons glyphicons-circle-exclamation-mark"></span> Ayuda</a>
						</div>
						
						
<script>
function submitThisformAgregarUsuario()
{
	
	var formulario= $('#formAgregarUsuario');
	...
	formulario.validate({
		  rules: {
		    ...
		    messages: {
		    	nombre_usu: "Debe indicar el  Nombre del usuario",
		    	apellido_usu: "Debe indicar el apellido",
		    	username:"Debe indicar el nombre de usuario de Intranet",
		    	password:"Debe indicar Contraseña",
		    	id_area:"Debe indicar el área",
		    	id_perfil:"Debe indicar el perfil del nuevo usuario"
          }
		  });
