...
<div class="box boxpost">
  ...
  <h4>Ingresa una palabra que esté en el nombre</h4>
          ...
          <form id="formBuscarEntidadExterna" action="clienteAction.do" method="POST"  class="form-horizontal">
  	...
  	<div class="form-group">
          ...
          <div class="boxOpciones">
    								<div class="form-group">
    									<div class="col-sm-12">
      									<a href="javascript:submitThisForm()" class="busca botoVerde"><span class="glyphicons glyphicons-search"></span> Buscar</a>
      								</div>
  									</div>
    							</div>
          </form>
...
<display:table name="entses" pagesize="15" requestURI="clienteAction.do" class="table table-striped table-bordered table-hover tablesorter" id="entss">
  <display:caption>Entidades Encontradas </display:caption>
        ...
        <display:column title="Editar" href="javascript:Llamadalink('aeditarEntidadExterna','#')"   paramId="id_ent" paramProperty="idEnt">  <p class="botoGris botoMini">Editar</p>
        </display:column>
