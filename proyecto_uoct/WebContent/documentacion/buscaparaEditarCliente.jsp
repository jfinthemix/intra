...
<form id="formPorPalabra" action="clienteAction.do" method="POST">
<div class="form-group">
        ...
        <input type="hidden" name="PorPalabra" value="Buscar" />
  										...
  										<label for="inputBusca1">
  											...
  											<small>*Nombre, apellido, etc.</small>
  										</label>
    									<input name="palClave" type="text" class="form-control" id="inputBusca1">
  									</div>
  									<a class="botoVerde busca" href="javascript:submitThisForm1()"><span class="glyphicons glyphicons-search"></span> Buscar</a>
</form>

</div>
<div class="col-md-6 searchtab">
				 				<form id="formParticulares" action="clienteAction.do">
  									...
  									<a class="botoVerde busca" href="javascript:submitThisForm2()"><span class="glyphicons glyphicons-search"></span> Buscar</a>
								</form>
				 			</div>          
   </div>           
  ...
  %>
        ...
        <display:setProperty name="export.amount" value="list"/>
		  ...
		  <display:column title="Nombre del Cliente" sortProperty="nomCli" sortable="true" href="javascript:Llamadalink('detalleCliente','#')" paramId="id_cli" paramProperty="idCli">
      ...
      if(((CliEntVO)clis).getIsActivo().intValue()==0){%>
          <%="Desactivado"%>
          <%}%>
          </display:column> <display:column title="Editar" href="javascript:Llamadalink('aeditarDatosCli','#')" paramId="idCli" paramProperty="idCli" >
          <p class="botoGris botoMini">Editar</p>
...
function submitThisForm2()
{
	...
	var formulario= $('#formParticulares');
	var action='documentacion/clienteAction.do';
	SubmitFormulario(action, formulario);
	$('#divResultado').removeClass( "encuentra" );
}
