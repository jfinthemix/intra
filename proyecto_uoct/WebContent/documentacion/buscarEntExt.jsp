...
<h4>Ingresa una palabra que esté en el nombre</h4>
          ...
          <div class="form-group">
    								...
    								<div class="form-group">
    									<div class="col-sm-12">
      									<a id="abtnBuscarEntidadExterna"  href="javascript:submitThisForm()" class="busca botoVerde"><span class="glyphicons glyphicons-search"></span> Buscar</a>
      								</div>
  									</div>
    							</div>
...
<div class="box boxpost">
        ...
        <a href="javascript:Llamadalink('detalleEntExt','<%=((EntExtVO)entss).getIdEnt()%>','<%=((EntExtVO)entss).getNomEnt()%>')"><%=((EntExtVO)entss).getNomEnt()%></a> </display:column> </display:table>
