...
//System.out.println("hacia="+hacia);
        ...
        private ActionForward buscar(ActionMapping actionMapping,
            ...
            try {
                ...
                e.printStackTrace();
                servletRequest.setAttribute("mensaje", "No se pudo cargar la búsqueda.[buscar, dispositivoAction]");
                return actionMapping.findForward("mensaje_fw");
            }
        }
        /* ingresar */
        private ActionForward ingresar(ActionMapping actionMapping,
            ...
            try {
                ...
                e.printStackTrace();
                servletRequest.setAttribute("mensaje", "No se pudo cargar los parámetros para el ingreso.[ingresar, dispositivoAction]");
                return actionMapping.findForward("mensaje_fw");
            }
        }
        /* resultado_ingresar */
        private ActionForward resultado_ingresar(ActionMapping actionMapping,
            ...
            try {
                ...
                if(accion==-1){//Modificar
                    ...
                    //PROBANDO
                    //servletRequest.setAttribute("mensaje","Se ha modificado la información del dispositivo.");
                    msj = "Se ha modificado la información del dispositivo.";
                }
                else{//Ingresar nuevo
        ...
        private ActionForward modificar(ActionMapping actionMapping,
            ...
            try {
                ...
                e.printStackTrace();
                servletRequest.setAttribute("mensaje", "No se pudo llegar a la página para modificar el dispositivo.[modificar, dispositivoAction]");
                return actionMapping.findForward("mensaje_fw");
            }
        }
        ...
        private ActionForward eliminar(ActionMapping actionMapping,
            ...
            try {
                ...
                if(respuesta=="si"){
                    ...
                    servletRequest.setAttribute("mensaje", "El dispositivo fue eliminado con éxito.");
                }
                else{
