...
import proyecto_uoct.proyecto.model.*;
...
public class ProyectoAction extends Action {
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if (request.getParameter("hacia") != null) {
            ...
            request.setAttribute("mensaje", "Error al cargar la página. Si está subiendo un archivo, verifique que su tamaño no supera los 10 MB ");
            return actionMapping.findForward("mensaje_fw");
        }

        Integer ses_idusu = (Integer) datoses.getId();
...
//-------------------------------
        ...
        /*        if (hacia.compareTo("aRegDocEntrante") == 0) {
         return aRegDocEntrante(actionMapping, request, httpSession);

                }
                if (hacia.compareTo("aRegDocSaliente") == 0) {
         return aRegDocSaliente(actionMapping, request, httpSession);
                }*/
...
//-----------NLO ------------------
        ...
        request.setAttribute("mensaje", "URL errónea");
        return actionMapping.findForward("mensaje_fw");
     ...
     */
    private ActionForward eliminarNLO(ActionMapping actionMapping,
                                      HttpServletRequest request) {
        try {
            ...
            ProyectoLocal proyectoLocal = LocalizadorServicios.getInstance().
                                          getProyectoLocal();

            proyectoLocal.eliminarNLO(idNLO);
            request.setAttribute("mensaje",
                                 "La NLO fue eliminada exitosamente");
            return actionMapping.findForward("mensaje_fw");
        } catch (Exception ex) {
            ex.printStackTrace();
            request.setAttribute("mensaje",
                                 "No se pudo eliminar la NLO");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward actualizarNLO(ActionMapping actionMapping,
                                        HttpServletRequest request) {
        try {
            ...
            request.setAttribute("mensaje",
                                 "La NLO fue actualizada exitosamente");
            return actionMapping.findForward("mensaje_fw");
        } catch (Exception ex) {
            ex.printStackTrace();
            request.setAttribute("mensaje",
                                 "No se pudo actualizar la NLO");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward adminNLOdelaOT(ActionMapping actionMapping,
                                         HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            DetalleOTVO detot = proyLoc.getDetalleOT(Integer.
                    valueOf(request.getParameter("idOT")));
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar la pag. de administración de NLO");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward adminNLOdelaIni(ActionMapping actionMapping,
                                          HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            DetalleProyectoVO det = proyLoc.getDetalleIniciativa(Integer.
                    valueOf(request.getParameter("idProy")));
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar el administración de NLO");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward editarNLO(ActionMapping actionMapping,
                                    HttpServletRequest request) {
        try {
            ProyectoLocal p = LocalizadorServicios.getInstance().
                              getProyectoLocal();
            ...
            if (request.getParameter("idProy") != null) {
                Integer idProy = Integer.valueOf(request.getParameter(
                        "idProy"));
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "No se pudo cargar la pag. de edición de la NLO");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward borrarOT(ActionMapping actionMapping,
                                   HttpServletRequest request) {
        try {
            ProyectoLocal p = LocalizadorServicios.getInstance().
                              getProyectoLocal();
            ...
            request.setAttribute("mensaje",
                                 "La OT fue eliminada exitosamente");
     ...
     * @return ActionForward
     */
    private ActionForward actualizarOT(ActionMapping actionMapping,
                                       HttpServletRequest request) {
        try {
            ...
            request.setAttribute("mensaje",
                                 "La OT fue actualizada exitosamente");
            return detalleOT(actionMapping,request);
        } catch (Exception ex) {
            ex.printStackTrace();
            request.setAttribute("mensaje",
     ...
     * @return ActionForward
     */
    private ActionForward finalizarIni(ActionMapping actionMapping,
                                       HttpServletRequest request) {
        try {
            ProyectoLocal p = LocalizadorServicios.getInstance().
                              getProyectoLocal();
            DetalleProyectoVO det = p.getDetalleIniciativa(Integer.valueOf(
                    request.getParameter("idProy")));
            det.setFechaFin(request.getParameter("fechaFin"));

            p.finalizarIni(det);

            request.setAttribute("mensaje",
                                 "La iniciativa ha sido cerrada con fecha:" +
                                 request.getParameter("fechaFin"));
            return actionMapping.findForward("mensaje_fw");
        } catch (Exception e) {
            request.setAttribute("mensaje",
                                 "No se pudo cargar la pag. de finalización de la Iniciativa ");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward aFinalizarIni(ActionMapping actionMapping,
                                        HttpServletRequest request) {
        try {
            ProyectoLocal p = LocalizadorServicios.getInstance().
                              getProyectoLocal();
     ...
     * @return ActionForward
     */
    private ActionForward editarOT(ActionMapping actionMapping,
                                   HttpServletRequest request) {
        ...
        try {
            ...
            proyectoLocal = LocalizadorServicios.getInstance().
                            getProyectoLocal();

            DetalleProyectoVO det = proyectoLocal.getDetalleIniciativa(
                    Integer.
                    valueOf(request.getParameter("idProy")));

            DocumentoLocal docLoc = LocalizadorServicios.getInstance().
                                    getDocumentoLocal();

            request.setAttribute("estados", proyectoLocal.getEstadosOT());
            request.setAttribute("detalleProy", det);

            request.setAttribute("detalleOT",
                                 proyectoLocal.getDetalleOT(id_OT));
            return actionMapping.findForward("editarOT_fw");
        } catch (Exception ex) {
            request.setAttribute("mensaje",
                                 "No se pudo cargar la pag. de edición de la OT");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward adminOTs(ActionMapping actionMapping,
                                   HttpServletRequest request) {
        try {
            ProyectoLocal p = LocalizadorServicios.getInstance().
                              getProyectoLocal();
            ...
            request.setAttribute("detalleProy",
                                 p.getDetalleIniciativa(Integer.
                    valueOf(request.getParameter("idProy"))));
            return actionMapping.findForward("adminOTs_fw");
        } catch (Exception e) {
            request.setAttribute("mensaje",
                                 "No se pudo cargar la pag. de administración de OTs ");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward actualizarFechas(ActionMapping actionMapping,
                                           HttpServletRequest request) {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
            ...
            if (!request.getParameter("fecha_tconc").equals("")) {
                det.setFinTareas(sdf.parse(request.getParameter(
                        "fecha_tconc")));
            }

            if (!request.getParameter("fecha_apro").equals("")) {
                det.setAprobacion(sdf.parse(request.getParameter(
                        "fecha_apro")));
            }

            proyLoc.actualizarFechasOT(det);
            request.setAttribute("mensaje",
                                 "las fechas de la OT fueron actualizadas exitosamente");
            return actionMapping.findForward("mensaje_fw");
        } catch (Exception e) {
            request.setAttribute("mensaje",
                                 "No se pudieron actualizar las fechas de la Ot ");
            return actionMapping.findForward("mensaje_fw");
        }
     ...
     * @return ActionForward
     */
    private ActionForward buscarNLO(ActionMapping actionMapping,
                                    HttpServletRequest request,
                                    ActionForm actionForm) {
        try {
            ProyectoLocal proyectoLocal = LocalizadorServicios.getInstance().
            ...
            if (request.getParameter("buscar") != null) {
                ...
                if (!request.getParameter("idnlo").equals("")) {
                    ...
                    bus.setIdNLO(Integer.valueOf(request.getParameter(
                            "idnlo")));
                }
            ...
            ex.printStackTrace();
            request.setAttribute("mensaje",
                                 "No se pudo cargar la busqueda de nlo");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward buscarOT(ActionMapping actionMapping,
                                   HttpServletRequest request) {
        try {
            ProyectoLocal proyectoLocal = LocalizadorServicios.getInstance().
                                          getProyectoLocal();
            ...
            if (request.getParameter("buscar") != null) {
                ...
                if (!request.getParameter("idEstado").equals("")) {
                    busOT.setIdEstado(Integer.valueOf(request.getParameter(
                            "idEstado")));
                }
                busOT.setFechaVenc(request.getParameter("fechaVenc"));
            ...
            request.setAttribute("mensaje",
                                 "No se pudo cargar la busqueda de OT");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward detalleOT(ActionMapping actionMapping,
                                    HttpServletRequest request) {
        try {
            Integer id_OT = Integer.valueOf(request.getParameter("idOT"));
            ProyectoLocal proyectoLocal = LocalizadorServicios.getInstance().
            ...
            UsuarioLocal usuLoc = LocalizadorServicios.getInstance().
                                  getUsuarioLocal();
     ...
     * @return ActionForward
     */
    private ActionForward otsdelProyToRegNLO(ActionMapping actionMapping,
                                             HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar la pag. de lista de OT");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward aRegNLOOT(ActionMapping actionMapping,
                                    HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            //lista los tipos de docs que tienen la palabra LO, salientes,activos
            List tiposDoc = docLoc.getTiposDocxPal("LO", new Integer(2),
                    new Integer(1));
            ...
            List tiposDocIn = docLoc.getTiposDocxPal("LO", new Integer(1),
                    new Integer(1));
            ...
            request.setAttribute("detalleProy",
                                 proyLoc.getDetalleIniDesdeOT(idOT));
            return actionMapping.findForward("regNLOOT_fw");
        } catch (Exception e) {
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar la pag. de registro de OT");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward registrarNLO(ActionMapping actionMapping,
                                       HttpServletRequest request,
                                       ActionForm actionForm) {
        try {
            ...
            Integer idTipoDoc = Integer.valueOf(request.getParameter(
                    "idTipoDoc"));
            ...
            AgregarDocProy_fb docAF = (AgregarDocProy_fb) actionForm; // Se llama al bean que recibe los Documentos
            ...
            request.setAttribute("mensaje",
                                 "La NLO fue registrada exitosamente");
     ...
     * @return ActionForward
     */
    private ActionForward editarFechasOT(ActionMapping actionMapping,
                                         HttpServletRequest request) {
     ...
     * @return ActionForward
     */
    private ActionForward aRegNLOdeIni(ActionMapping actionMapping,
                                       HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar la pag. de registro de NLO");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward busInitoNLO(ActionMapping actionMapping,
                                      HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            request.setAttribute("proyectos",
                                 proyLoc.getProyectosxAno(ano, true,
                    datoses.getId()));
            return actionMapping.findForward("busInitoNLO_fw");
        } catch (Exception e) {
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar la pag. de búsqueda de Iniciativas");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward abusInitoNLO(ActionMapping actionMapping,
                                       HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
     ...
     * @return ActionForward
     */
    private ActionForward registrarOT(ActionMapping actionMapping,
                                      HttpServletRequest request,
                                      ActionForm actionForm) {
        try {
            ...
            request.setAttribute("mensaje",
                                 "La OT fue registrada exitosamente");
            return detalleIniciativa(actionMapping,request);
        } catch (Exception ex) {
            ex.printStackTrace();
            request.setAttribute("mensaje",
                                 "No se pudo registrar la OT");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward buscarIniToOT(ActionMapping actionMapping,
                                        HttpServletRequest request,
        ...
        try {
            ...
            List proyectos = proyectoLocal.getProyectosxAno(ano, true,
                    datoses.getId());
     ...
     * @return ActionForward
     */
    private ActionForward aBuscarIniToOT(ActionMapping actionMapping,
                                         HttpServletRequest request,
                                         HttpSession httpSession) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
     ...
     * @return ActionForward
     */
    private ActionForward aRegOT(ActionMapping actionMapping,
                                 HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            request.setAttribute("tiposDocOut",
                                 docLoc.getTiposDocxPal("OT", new Integer(2),
                    new Integer(1)));
            request.setAttribute("tiposDocIn",
                                 docLoc.getTiposDocxPal("OT", new Integer(1),
                    new Integer(1)));
     ...
     * @return ActionForward
     */
    private ActionForward adminIni(ActionMapping actionMapping,
                                   HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar la pag. de administración de la iniciativa");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward actualizarIni(ActionMapping actionMapping,
                                        HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            detProy.setIdEncargado(new Integer(request.getParameter(
                    "id_encargado")));
            ...
            if (!request.getParameter("ftotales").equals("")) {
                detProy.setFondosTotales(new Integer(request.getParameter(
                        "ftotales")));
            }
            ...
            request.setAttribute("mensaje",
                                 "La Iniciativa de Inversión fue actualizada exitosamente");
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "No se pudo actualizar la Iniciativa de Inversión");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward editarIni(ActionMapping actionMapping,
                                    HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            request.setAttribute("listausu",
                                 usuarioLocal.getUsuariosActivos());
            request.setAttribute("detalleProy", det);
            return actionMapping.findForward("edtiarDatosIni_fw");
        } catch (Exception e) {
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar la pag de edición de la iniciativa");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward descargarDocIni(ActionMapping actionMapping,
                                          HttpServletRequest request,
                                          HttpServletResponse response) {
        try {
            ...
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            Integer idArchivo = Integer.valueOf(request.getParameter(
                    "idDoc"));
     ...
     * @return ActionForward
     */
    private ActionForward eliminarDoc(ActionMapping actionMapping,
                                      HttpServletRequest request) {
        try {
     ...
     * @return ActionForward
     */
    private ActionForward regDocIni(ActionMapping actionMapping,
                                    HttpServletRequest request,
                                    ActionForm actionForm) {
     ...
     * @return ActionForward
     */
    private ActionForward adminDocsIni(ActionMapping actionMapping,
                                       HttpServletRequest request) {
        try {
            Integer idIni = Integer.valueOf(request.getParameter("idProy"));
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar la pag. de administración de documentos de la iniciativa");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward buscarParaEditarIni(ActionMapping actionMapping,
                                              HttpServletRequest request) {
        try {
            Integer ano = Integer.valueOf(request.getParameter("ano"));
            ...
            request.setAttribute("proyectos",
                                 proyectoLocal.getProyectosxAno(ano, false,
                    datoses.getId()));
     ...
     * @return ActionForward
     */
    private ActionForward buscarIniciativas(ActionMapping actionMapping,
                                            HttpServletRequest request,
                                            HttpSession httpSession) {
        ...
        try {
            ...
            request.setAttribute("proyectosaCargo",
                                 proyectoLocal.getProyectos(ano, datoses.getId(),
                    "aCargo", true));
            request.setAttribute("proyectosEnEquipo",
                                 proyectoLocal.getProyectos(ano, datoses.getId(),
                    "enEquipo", true));
            request.setAttribute("otrosProyectos",
                                 proyectoLocal.getProyectos(ano, datoses.getId(),
                    "otros", true));
     ...
     * @return ActionForward
     */
    private ActionForward aBuscarparaEditarIni(ActionMapping actionMapping,
                                               HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            request.setAttribute("idSes", datoses.getId());
            request.setAttribute("proyectos",
                                 proyLoc.getProyectosxAno(ano, false,
                    datoses.getId()));
            return actionMapping.findForward("busParaEditarIni_fw");
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @return ActionForward
     */
    private ActionForward detalleIniciativa(ActionMapping actionMapping,
                                            HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            DetalleProyectoVO det = null;
             ...
             try{
                det = proyLoc.getDetalleIniciativa(Integer.
                                             valueOf(request.getParameter("idProy")));
           ...
           datoses = (DatosSesVO) httpSession.getAttribute("Ses_Usu");
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "no se pudo cargar el detalle de la iniciativa");
            return actionMapping.findForward("mensaje_fw");
        }
     ...
     * @return ActionForward
     */
    private ActionForward aBusIni(ActionMapping actionMapping,
                                  HttpServletRequest request,
                                  HttpSession httpSession) {
        ...
        try {
            ...
            request.setAttribute("proyectosaCargo",
                                 proyLoc.getProyectos(ano, ds.getId(), "aCargo", true));
            request.setAttribute("proyectosEnEquipo",
                                 proyLoc.getProyectos(ano, ds.getId(),
                    "enEquipo", true));
            request.setAttribute("otrosProyectos",
                                 proyLoc.getProyectos(ano, ds.getId(), "otros", true));
            return actionMapping.findForward("busIniciativas_fw");
        } catch (Exception e) {
            e.printStackTrace();
            request.setAttribute("mensaje",
     ...
     * @return ActionForward
     */
    private ActionForward registrarIniciativa(ActionMapping actionMapping,
                                              HttpServletRequest request) {
        try {
            ProyectoLocal proyLoc = LocalizadorServicios.getInstance().
                                    getProyectoLocal();
            ...
            request.setAttribute("mensaje",
                                 "La Iniciativa de Inversión fue registrada exitosamente");
            return actionMapping.findForward("mensaje_fw");
        } catch (Exception e) {
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "No se pudo registrar la Iniciativa de Inversión");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward aRegistrarIniciativa(ActionMapping actionMapping,
                                               HttpServletRequest request) {
        try {
            UsuarioLocal usuarioLocal = LocalizadorServicios.getInstance().
                                        getUsuarioLocal();
            ...
            e.printStackTrace();
            request.setAttribute("mensaje",
                                 "No se pudo cargar la pag de registro de Iniciativa de Inversión");
            return actionMapping.findForward("mensaje_fw");
        }
    }
    ...
    /*    private ActionForward aRegDocSaliente(ActionMapping actionMapping,
            ...
            request.setAttribute("tiposentrantes", tiposentrantes);
     ...
     * @return ActionForward
     */
    private ActionForward aEditarProy(ActionMapping actionMapping,
                                      HttpServletRequest request,
                                      HttpSession httpsession) {
...
//        request.setAttribute("detalleProy", proy);
    ...
    /*    private ActionForward aregnlocOT(ActionMapping actionMapping,
        ...
        Integer id_proyecto = Integer.valueOf(request.getParameter(
                "id_proyecto"));
        Integer id_ot = null;
        if (request.getParameter("id_ot") != null) {
            id_ot = Integer.valueOf(request.getParameter("id_ot"));
        }
        ...
        if (id_ot != null) {
            DetalleOTVO detot = proyectoLocal.getDetalleOT(id_ot);
            request.setAttribute("detot", detot);
        }
