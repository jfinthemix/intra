...
//--------      TIPOS DE EIV        ----------
            if (hacia.equals("cargarTiposEIV")) {
                return cargaTiposEIV(actionMapping, servletRequest,
                                     httpsession);
            }
            if (hacia.equals("eliminarTipoEIV")) {
                return eliminarTipoEIV(actionMapping, servletRequest,
                                       httpsession);
            }
            if (hacia.equals("agregarTipoEIV")) {
                return agregarTipoEIV(actionMapping, servletRequest,
                                      httpsession);
            }

//----------------------------------
            if (hacia.equals("cargarRegistrarEIV")) {
                return cargarRegistrarEIV(actionMapping, servletRequest,
                                          httpsession);
            }

            if (hacia.equals("cargarBusDoc")) {
                return cargarBusDocOficio(actionMapping, servletRequest,
                                          httpsession);
            }

            if (hacia.equals("buscarDocOficio")) {
                return buscarDocOficio(actionMapping, servletRequest,
                                       httpsession);
            }

            if (hacia.equals("detEIVydetEventos")) {
                return detEIVyDetEventos(actionMapping, servletRequest,
                                         httpsession);
            }
            if (hacia.equals("detEIVyle")) {
                return detEIVyle(actionMapping, servletRequest,
                                 httpsession);
            }
            if (hacia.equals("detEIVydetEventyflujos")) {
                return detEIVydetEventyflujos(actionMapping, servletRequest,
                                              httpsession);
            }

            /*if (hacia.equals("aCorregirEvento")) {
                return aCorregirEvento(actionMapping, servletRequest,
                                       httpsession);
                     }*/
            if (hacia.equals("detEvento")) {
                return detEvento(actionMapping, servletRequest,
                                 httpsession);
            }

            if (hacia.equals("aEnvioEmail")) {
                return aEnvioEmail(actionMapping, servletRequest,
                                   httpsession);
            }

            if (hacia.equals("enviarEmail")) {
                return enviarEmail(actionMapping, servletRequest,
                                   httpsession);
            }

            if (hacia.equals("aEnviarEmailIngreso")) {
                return aEnviarEmailIngreso(actionMapping, servletRequest,
                                           httpsession);
            }
            ...
            if (hacia.equals("registrarEIV")) {
                return registrarEIV(actionMapping, servletRequest,
                                    httpsession);
            }
...
//---------- COMUNAS ---------------
            ...
            if (hacia.equals("adminComunas")) {
                return adminComunas(actionMapping, servletRequest,
                                    httpsession);
            }
            if (hacia.equals("eliminarComuna")) {
                return eliminarComuna(actionMapping, servletRequest,
                                      httpsession);
            }
            if (hacia.equals("agregarComuna")) {
                return agregarComuna(actionMapping, servletRequest,
                                     httpsession);
            }
...
//----------------------------------------------------
            ...
            if (hacia.equals("cargarBuscarEIV")) {
                return cargarBuscarEIV(actionMapping, servletRequest,
                                       httpsession);
            }

            if (hacia.equals("buscarEIV")) {
                return buscarEIV(actionMapping, servletRequest,
                                 httpsession);
            }
            if (hacia.equals("detalleEIV")) {
                return detalleEIV(actionMapping, servletRequest,
                                  httpsession);
            }
            if (hacia.equals("abuscarParaEditarEIV")) {
                return abusParaEditarEIV(actionMapping, servletRequest,
                                         httpsession);
            }
            if (hacia.equals("busParaEditarEIV")) {
                return busParaEditarEIV(actionMapping, servletRequest,
                                        httpsession);
            }

            if (hacia.equals("editarEIV")) {
                return editarEIV(actionMapping, servletRequest,
                                 httpsession);
            }

            if (hacia.equals("actualizarEIV")) {
                return actualizarEIV(actionMapping, servletRequest,
                                     httpsession);
            }
...
//----BITACORA----------------------
            ...
            if (hacia.equals("aAgregarBit")) {
                return aAgregarEvento(actionMapping, servletRequest,
                                      httpsession);
            }

            if (hacia.equals("primeraRev")) {
                return regPrimeraRev(actionMapping, servletRequest,
                                     httpsession);
            }

            if (hacia.equals("reingresarEIV")) {
                return reingresarEIV(actionMapping, servletRequest,
                                     httpsession);
            }

            if (hacia.equals("aprobar_UOCT")) {
                return aprobarUOCT(actionMapping, servletRequest,
                                   httpsession);
            }

            if (hacia.equals("rechazar_UOCT")) {
                return rechazarUOCT(actionMapping, servletRequest,
                                    httpsession);
            }

            if (hacia.equals("aprobar_SEREMITT")) {
                return aprobarSEREMITT(actionMapping, servletRequest,
                                       httpsession);
            }

            if (hacia.equals("rechazar_SEREMITT")) {
                return rechazarSEREMITT(actionMapping, servletRequest,
                                        httpsession);
            }

            if (hacia.equals("agregarEvento")) {
                return agregarEvento(actionMapping, servletRequest,
                                     httpsession);
            }

            if (hacia.equals("editarEvento")) {
                return editarEvento(actionMapping, servletRequest,
                                    httpsession);
            }

            if (hacia.equals("actualizarEvento")) {
                return actualizarEvento(actionMapping, servletRequest,
                                        httpsession);
            }

            if (hacia.equals("despacharEIV")) {
                return despacharEIV(actionMapping, servletRequest,
                                    httpsession);
            }
            if (hacia.equals("aDespachar")) {
                return aDespachar(actionMapping, servletRequest,
                                  httpsession);
            }

            /*      if (hacia.equals("aReingresar")) {
                      return aReingresar(actionMapping, servletRequest,
                                         httpsession);
                  }



                  if (hacia.equals("aAprobRech")) {
                      return aAprobRech(actionMapping, servletRequest,
                                        httpsession);
                  }

                  if (hacia.equals("aprobar_rechazar")) {
                      return aprob_rech(actionMapping, servletRequest,
                                        httpsession);
                  }
             */
            if (hacia.equals("eliminarEvento")) {
                return eliminarEvento(actionMapping, servletRequest,
                                      httpsession);
            }

            if (hacia.equals("editarFlujos")) {
                return editarFlujos(actionMapping, servletRequest,
                                    httpsession);
            }
...
//----------------------------------------------------------
     ...
     * actualizarEvento
     *
     * Recibe y procesa la petición de actualizar los datos de un evento
     * de una bitácora.
     *
     ...
     */
    private ActionForward actualizarEvento(ActionMapping actionMapping,
                                           HttpServletRequest servletRequest,
                                           HttpSession httpsession) {
        try {
            Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
                    "id_eiv"));
            Integer idEvento = Integer.valueOf(servletRequest.getParameter(
                    "idEvento"));
            ...
            servletRequest.setAttribute("mensaje",
                                        "Error en el procesamiento de la actualización");
            return actionMapping.findForward("mensaje_fw");
        }
     ...
     * editarEvento
     *
     * Obtiene los datos de un evento de bitácora de un EIV y
     * los envía a la página correspondiente para la edición de los datos.
     *
     * @param actionMapping ActionMapping
     * @param servletRequest HttpServletRequest
     * @param httpsession HttpSession
     * @return ActionForward
     */
    private ActionForward editarEvento(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest,
                                       HttpSession httpsession) {
        ...
        try {
            ...
            servletRequest.setAttribute("detEvento",
                                        eivLocal.getDetalleEvento(idEvento));
            servletRequest.setAttribute("nomEIV", nomEIV);
            servletRequest.setAttribute("id_eiv", id_eiv);
            ...
            System.out.print(e.toString());
            servletRequest.setAttribute("mensaje",
                                        "Error en el procesamiento de la petición");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward rechazarSEREMITT(ActionMapping actionMapping,
                                           HttpServletRequest servletRequest,
                                           HttpSession httpsession) {
        try {
            Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
            ...
            if (!servletRequest.getParameter("idDoc").equals("")) {
                id_doc = Integer.valueOf(servletRequest.
                                         getParameter("idDoc"));
            ...
            boolean isInsertEvento = eivLocal.insertEventoEIV(nuevoev,
                    id_eiv, new Integer(7)); // Para el último parametro ver comentario del metodo

            if (isInsertEvento) {
                servletRequest.setAttribute("mensaje",
                                            "La bitácora ha sido ingresada. El EIV ha sido registrado como rechazado por seremitt" +
                                            "<br><br><a href='eivAction.do?hacia=detalleEIV&id_eiv=" + id_eiv + "'>Ver Detalle del EIV</a>");

            } else {
                servletRequest.setAttribute("mensaje",
                                            "La bitácora no pudo ser ingresada");
            }
            return actionMapping.findForward("mensaje_fw");
            //            return detalleEIV(actionMapping, servletRequest, httpsession);
     ...
     * @return ActionForward
     */
    private ActionForward aprobarSEREMITT(ActionMapping actionMapping,
                                          HttpServletRequest servletRequest,
                                          HttpSession httpsession) {
        try {
            Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
            ...
            boolean isInsertEvento = eivLocal.insertEventoEIV(nuevoev,
                    id_eiv, new Integer(6)); // Para el último parametro ver comentario del metodo

            if (isInsertEvento) {
                servletRequest.setAttribute("mensaje",
                                            "La bitácora ha sido ingresada.El EIV ha sido registrado como aprobado por seremitt" +
                                            "<br><br><a href='eivAction.do?hacia=detalleEIV&id_eiv=" +
                                            id_eiv +
     ...
     * @return ActionForward
     */
    private ActionForward rechazarUOCT(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest,
                                       HttpSession httpsession) {
        try {
            Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
            ...
            boolean isInsertEvento = eivLocal.insertEventoEIV(nuevoev,
                    id_eiv, new Integer(5)); // Para el último parametro ver comentario del metodo

            if (isInsertEvento) {
                servletRequest.setAttribute("mensaje",
                                            "La bitácora ha sido ingresada. El EIV ha sido registrado como rechazado por UOCT" +
                                            "<br><br><a href='eivAction.do?hacia=detalleEIV&id_eiv=" +
                                            id_eiv +
                                            "'>Ver Detalle del EIV</a>");
     ...
     * @return ActionForward
     */
    private ActionForward aprobarUOCT(ActionMapping actionMapping,
                                      HttpServletRequest servletRequest,
                                      HttpSession httpsession) {
        try {
            Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
            ...
            boolean isInsertEvento = eivLocal.insertEventoEIV(nuevoev,
                    id_eiv, new Integer(4)); // Para el último parametro ver comentario del metodo

            if (isInsertEvento) {
                servletRequest.setAttribute("mensaje",
                                            "La bitácora ha sido ingresada .El EIV ha sido registrado como aprobado por UOCT" +
                                            "<br><br><a href='eivAction.do?hacia=detalleEIV&id_eiv=" +
                                            id_eiv +
                                            "'>Ver Detalle del EIV</a>");
     ...
     * @return ActionForward
     */
    private ActionForward regPrimeraRev(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest,
                                        HttpSession httpsession) {
        try {
            Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
            ...
            boolean isInsertEvento = eivLocal.insertEventoEIV(nuevoev,
                    id_eiv, new Integer(1)); //para el ultimo parametro ver el comentario del metodo

            if (isInsertEvento) {
                servletRequest.setAttribute("mensaje",
                                            "La bitácora ha sido ingresada como Primera Revisión, " +
     ...
     * @return ActionForward
     */
    private ActionForward aAgregarEvento(ActionMapping actionMapping,
                                         HttpServletRequest servletRequest,
                                         HttpSession httpsession) {
        try {
            EIVLocal eivLocal = LocalizadorServicios.getInstance().getEIVLocal();
            ...
            UsuarioLocal usuarioLoc = LocalizadorServicios.getInstance().
                                      getUsuarioLocal();
            DatosSesVO ds = (DatosSesVO) httpsession.getAttribute("Ses_Usu");

            if (usuarioLoc.tienePermiso(ds.getIdPerfil(),
                                        "Registrar Primera Revision")) {
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la página de registro de bitácora");
            return actionMapping.findForward("mensaje_fw");
        }
     ...
     * @return ActionForward
     */
    private ActionForward editarFlujos(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest,
                                       HttpSession httpsession) {
        try {
            servletRequest.setAttribute("id_eiv",
                                        Integer.valueOf(servletRequest.
                    getParameter("id_eiv")));
            return actionMapping.findForward("registrarFlujo_fw");
        } catch (Exception e) {
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la página de flujos vehiculares");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward aEnviarEmailIngreso(ActionMapping actionMapping,
                                              HttpServletRequest servletRequest,
                                              HttpSession httpsession) {
        try {
            ...
            if (servletRequest.getParameter("nomEIV") != null &&
                servletRequest.getParameter("id_eiv") != null) {
                nomEIV = servletRequest.getParameter("nomEIV");
                id_eiv = Integer.valueOf(servletRequest.getParameter(
                        "id_eiv"));
            } else {
            ...
            if (rmt == null) {
                servletRequest.setAttribute("mensaje",
                                            "La dirección de Email de su cuenta de Intranet no ha sido configurada. Registrela y vuelva a intentar el envio de email<br/> Configurela en 'Editar Datos personales' y vuelva a intentarlo'");
                return actionMapping.findForward("mensaje_fw");
            }
            ...
            ex.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la página de envío de email");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward enviarEmail(ActionMapping actionMapping,
                                      HttpServletRequest servletRequest,
                                      HttpSession httpsession) {
        try {
            ...
            if (rmt == null) {
                servletRequest.setAttribute("mensaje",
                                            "No se recibió correctamente la dirección de Email del remitente");
                return actionMapping.findForward("mensaje_fw");
            } else {
                eivlocal.alertaEmail(rmt, passw,
                                     servletRequest.getParameter("emails") +
                                     "," + rmt,
                                     servletRequest.getParameter("subject"),
            ...
            servletRequest.setAttribute("id_eiv",
                    ...
                    getParameter("id_eiv")));
            servletRequest.setAttribute("nomEIV",
                                        servletRequest.getParameter("nomEIV"));
            servletRequest.setAttribute("mensaje",
     ...
     * @return ActionForward
     */
    private ActionForward eliminarEvento(ActionMapping actionMapping,
                                         HttpServletRequest servletRequest,
                                         HttpSession httpsession) {
        try {
            Integer idEvento = Integer.valueOf(servletRequest.getParameter(
    ...
    /* private ActionForward aprob_rech(ActionMapping actionMapping,
         ...
         try {
             Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
                     "id_eiv"));
     EIVLocal eivLocal = LocalizadorServicios.getInstance().getEIVLocal();
             String fechaDespacho = servletRequest.getParameter("fecha");
             String desc_ev = servletRequest.getParameter("desc_ev");
             Integer accion = Integer.valueOf(servletRequest.getParameter(
                     "accion"));
             String titulo = null;
             if (accion.intValue() == 1) {
                 titulo = "Aprobación de EIV";
             }
             if (accion.intValue() == 2) {
                 titulo = "Rechazo de EIV";
             }
             EventoVO nuevoev = new EventoVO();
             Integer id_doc = null;
             id_doc = Integer.valueOf(servletRequest.
             ...
             nuevoev.setDescEv(desc_ev);
             nuevoev.setTitulo(titulo);
             boolean isInsertEvento = eivLocal.aprobar_rechazar(nuevoev,
                     id_eiv, accion);
             if (isInsertEvento) {
                 servletRequest.setAttribute("mensaje",
     "El operación efectuada exitosamente");
             } else {
                 servletRequest.setAttribute("mensaje",
     "La operacion no pudo ser realizada");
             }
             return detalleEIV(actionMapping, servletRequest, httpsession);
             //return aAprobRech(actionMapping, servletRequest, httpsession);
         } catch (Exception e) {
             e.printStackTrace();
             servletRequest.setAttribute("mensaje",
                                         "No se pudo agregar bitácora");
     ...
     * @return ActionForward
     */
    private ActionForward reingresarEIV(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest,
                                        HttpSession httpsession) {
        try {
            Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
            ...
            String desc_ev = servletRequest.getParameter("desc_ev");
            String titulo = "Reingreso de Documentación";
            EventoVO nuevoev = new EventoVO();
            Integer id_doc = null;
            id_doc = Integer.valueOf(servletRequest.
                                     getParameter("idDoc"));
            ...
            nuevoev.setTitulo(titulo);
            boolean isInsertEvento = eivLocal.insertEventoEIV(nuevoev,
                    id_eiv, new Integer(2)); // ver comentario del metodo
            if (isInsertEvento) {
                servletRequest.setAttribute("mensaje",
                                            "El reingreso ha sido registrado" +
                                            "<BR><BR><a href='eivAction.do?hacia=detalleEIV&id_eiv=" +
                                            id_eiv +
                                            "'>Ver Detalle del EIV</a>");
                ...
                servletRequest.setAttribute("mensaje",
                                            "El reingreso no pudo ser registrado");
            }
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward despacharEIV(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest,
                                       HttpSession httpsession) {
        try {
            Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
            ...
            boolean isInsertEvento = eivLocal.insertEventoEIV(nuevoev,
                    id_eiv, new Integer(3)); // ver comentario del metodo
            if (isInsertEvento) {
                servletRequest.setAttribute("mensaje",
                                            "El despacho de documentación se ha registrado exitosamente" +
                                            "<BR><BR><a href='eivAction.do?hacia=detalleEIV&id_eiv=" +
                                            id_eiv +
                                            "'>Ver Detalle del EIV</a>");
            } else {
                servletRequest.setAttribute("mensaje",
                                            "No se pudo registrar el despacho de documentación");
            }
     ...
     * @return ActionForward
     */
    private ActionForward agregarEvento(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest,
                                        HttpSession httpsession) {
        try {
            Integer id_eiv = Integer.valueOf(servletRequest.getParameter(
            ...
            boolean isInsertEvento = eivLocal.insertEventoEIV(nuevoev,
                    id_eiv, new Integer(8)); // ver comentario del metodo
            if (isInsertEvento) {
                servletRequest.setAttribute("mensaje",
                                            "La bitácora ha sido ingresada" +
                                            "<BR><BR><a href='eivAction.do?hacia=detalleEIV&id_eiv=" +
                                            id_eiv +
                                            "'>Ver Detalle del EIV</a>");
     ...
     * @return ActionForward
     */
    private ActionForward editarBitacora(ActionMapping actionMapping,
                                         HttpServletRequest servletRequest,
                                         HttpSession httpsession) {
        ...
        try {
            ...
            ex4.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "no se pudo cargar la página de Bitacora del EIV");
            return actionMapping.findForward("bitacoraEIV_fw");
        }
     ...
     * @return ActionForward
     */
    private ActionForward actualizarEIV(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest,
                                        HttpSession httpsession) {
        try {
            EIVVO eiv = new EIVVO();
            ...
            eiv.setIdEstado(Integer.valueOf(servletRequest.getParameter(
                    "id_estado")));
            eiv.setIdTipoEstudio(Integer.valueOf(servletRequest.
                                                 getParameter("id_tipoestudio")));

            eiv.setFechaPresent(sdf.parse(servletRequest.getParameter(
                    "fechaPresentacion")));

            eiv.setFechaEnvioSeremitt(sdf.parse(servletRequest.
                                                getParameter(
                    "fechaEnvioSeremitt")));

            eiv.setFechaIng(sdf.parse(servletRequest.getParameter(
                    "fechaIngreso")));

            eiv.setFechaVenc(sdf.parse(servletRequest.getParameter(
                    "fechaVencimiento")));

            eiv.setIdComuna(Integer.valueOf(servletRequest.
                                            getParameter(
                    "idComuna")));
            ...
            eiv.setEstacionamientos(Integer.valueOf(servletRequest.
                    getParameter(
                            "estacionamientos")));
            eiv.setNomCons(servletRequest.getParameter("consultor"));

            if (!servletRequest.getParameter("empconsultora").equals("")) {
                eiv.setEmpCons(servletRequest.getParameter(
                        "empconsultora"));
            }
            eiv.setIdEncargado(Integer.valueOf(servletRequest.
                                               getParameter(
                    "id_ingeniero")));
            ...
            if (eivLocal.actualizarEIV(eiv)) {
                servletRequest.setAttribute("mensaje",
                                            "El Eiv fue actualizado correctamente");
                return detalleEIV(actionMapping, servletRequest, httpsession);
                //return actionMapping.findForward("mensaje_fw");
            }
            return actionMapping.findForward("registrarFlujo_fw");
     ...
     * @return ActionForward
     */
    private ActionForward editarEIV(ActionMapping actionMapping,
                                    HttpServletRequest servletRequest,
                                    HttpSession httpsession) {
        try {
            ...
            ex.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la página de Edición de EIV");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward busParaEditarEIV(ActionMapping actionMapping,
                                           HttpServletRequest servletRequest,
                                           HttpSession httpsession) {
        try {
            ...
            if (!servletRequest.getParameter("palClave").equals("")) {
                bus.setPalClave((String) servletRequest.getParameter("palClave"));
            }
            if (!servletRequest.getParameter("fechaVencimiento").equals("")) {
                bus.setFechaVenc((String) servletRequest.getParameter(
                        "fechaVencimiento"));
            }

            if (!servletRequest.getParameter("fechaVencimiento_b").equals("")) {
                bus.setFechaVenc_b((String) servletRequest.getParameter(
                        "fechaVencimiento_b"));
            }

            if (!servletRequest.getParameter("estado").equals("")) {
                bus.setIdEstado(Integer.valueOf(servletRequest.
                                                getParameter("estado")));
            }
            if (!servletRequest.getParameter("idIngeniero").equals("")) {
                bus.setIdIngeniero(Integer.valueOf((String) servletRequest.
                        getParameter("idIngeniero")));
            }
            if (!servletRequest.getParameter("idComuna").equals("")) {
                bus.setIdComuna(Integer.valueOf((String) servletRequest.
                                                getParameter("idComuna")));
            }

            if (!servletRequest.getParameter("red").equals("")) {
                bus.setRed(Integer.valueOf((String) servletRequest.getParameter(
                        "red")));
            }

            if (!servletRequest.getParameter("consultor").equals("")) {
                bus.setConsultor((String) servletRequest.getParameter(
                        "consultor"));
            }
...
// Si tiene permisos para registrar flujos
            ...
            boolean regFlujos = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "registrar flujos");
            Integer regF = null;
            if (regFlujos) {
                regF = new Integer(1);
...
// Si tiene permisos para editar la bitácora

            boolean edBit = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Editar bitácora");
            Integer edB = null;
            if (edBit) {
                edB = new Integer(1);
...
// Si tiene permisos para enviar Email de Vencimiento
            boolean email = usuarioLocal.tienePermiso(ds.getIdPerfil(),
...
// Si tiene permisos para enviar Editar los datos del EIV
            boolean editar = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Editar EISTU");
            Integer ed = null;
            if (editar) {
                ed = new Integer(1);
...
// CONSULTA SI EL USUARIO TIENE PERMISOS PARA REGISTRAR DISTINTOS TIPOS DE BITACORAS

            Integer regBit = null;

            boolean pri = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Registrar Primera Revision");

            boolean desp = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Despachar documento EIV");

            boolean ap_uoct = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Aprobar por UOCT");

            boolean rech_uoct = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Rechazar por UOCT");

            boolean ap_sere = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Aprobar por SEREMITT");

            boolean rech_sere = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Rechazar por SEREMITT");

            boolean reing = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Registrar Reingreso de EISTU");

            boolean otros = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Registrar otros eventos");

            if (pri || desp || ap_uoct || rech_uoct || ap_sere || rech_sere ||
                reing || otros) {
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la página de busqueda de EIV");
            return actionMapping.findForward("mensaje_fw");
        }
    ...
    /**
     * abusParaEditarEIV
     * Carga la pagina de búsqueda de EIV para editar.
     *
     * NOTAR QUE SE EXIGE QUE LOS NOMBRES DE LAS
     * FUNCIONALIDADES ASOCIADAS A LOS PERFILES
     * SEAN EXACTAMENTE COMO ESTÁN EN LA BASE DE DATOS!!
     *
     * @param actionMapping ActionMapping
     * @param servletRequest HttpServletRequest
     * @param httpsession HttpSession
     * @return ActionForward
     */
    private ActionForward abusParaEditarEIV(ActionMapping actionMapping,
                                            HttpServletRequest servletRequest,
                                            HttpSession httpsession) {
        try {
...
// CONSULTA SI EL USUARIO TIENE PERMISOS PARA REGISTRAR DISTINTOS TIPOS DE BITACORAS
     ...
     * @return ActionForward
     */
    private ActionForward detalleEIV(ActionMapping actionMapping,
                                     HttpServletRequest servletRequest,
                                     HttpSession httpsession) {
        ...
        try {
            ...
            servletRequest.setAttribute("detalleeiv",
                                         eivLocal.getDetalleEIV(id_eiv));
            servletRequest.setAttribute("eventos",
                                        eivLocal.getEventosEIV(id_eiv));
            return actionMapping.findForward("detEIV_fw");
        } catch (LocalizadorServiciosException ex) {
            ex.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar el detalle del EIV");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward buscarEIV(ActionMapping actionMapping,
                                    HttpServletRequest servletRequest,
                                    HttpSession httpsession) {
        try {
            BuscadorEIVVO bus = new BuscadorEIVVO();
            ...
            if (!servletRequest.getParameter("estadoSeremitt").equals("0")) {
                bus.setEstadoSeremitt(Integer.valueOf(servletRequest.
                        getParameter(
                                "estadoSeremitt")));
            }
     ...
     * @return ActionForward
     */
    private ActionForward cargarBuscarEIV(ActionMapping actionMapping,
                                          HttpServletRequest servletRequest,
                                          HttpSession httpsession) {
     ...
     * @return ActionForward
     */
    private ActionForward registrarEIV(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest,
                                       HttpSession httpsession) {
        ...
        try {
            ...
            nuevoeiv.setIdOficio(Integer.valueOf(servletRequest.
                                                 getParameter(
                    "idDocOficio")));

            nuevoeiv.setIdTipoEstudio(Integer.valueOf(servletRequest.
                    getParameter("id_tipoestudio")));

            nuevoeiv.setFechaPresent(sdf.parse(servletRequest.getParameter(
                    "fechaPresentacion")));

            nuevoeiv.setFechaEnvioSeremitt(sdf.parse(servletRequest.
                    getParameter(
                            "fechaEnvioSeremitt")));

            nuevoeiv.setFechaIng(sdf.parse(servletRequest.getParameter(
                    "fechaIngreso")));

            nuevoeiv.setFechaVenc(sdf.parse(servletRequest.getParameter(
                    "fechaVencimiento")));

            nuevoeiv.setIdComuna(Integer.valueOf(servletRequest.
                                                 getParameter(
                    "id_comuna")));
            ...
            nuevoeiv.setEstacionamientos(Integer.valueOf(servletRequest.
                    getParameter(
                            "estacionamientos")));
            nuevoeiv.setNomCons(servletRequest.getParameter("consultor"));

            if (!servletRequest.getParameter("empconsultora").equals("")) {
                nuevoeiv.setEmpCons(servletRequest.getParameter(
                        "empconsultora"));
            }
            nuevoeiv.setIdEncargado(Integer.valueOf(servletRequest.
                    getParameter(
                            "id_ingeniero")));
            ...
            if (idnuevo == null) {
                servletRequest.setAttribute("mensaje",
                                            "No se pudo registrar el EIV");
                return actionMapping.findForward("mensaje_fw");
            } else {
                servletRequest.setAttribute("mensaje",
                                            "El EIV fue registrado exitosamente");
            }
     ...
     * @return ActionForward
     */
    private ActionForward cargarRegistrarEIV(ActionMapping actionMapping,
                                             HttpServletRequest
                                             servletRequest,
                                             HttpSession httpsession) {
        try {
            ...
            ex.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la página de registro de EIV");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward agregarComuna(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest,
                                        HttpSession httpsession) {
        try {
            ...
            EIVLocal eivLocal = LocalizadorServicios.getInstance().
                                getEIVLocal();
            String nomComuna = (String) servletRequest.getParameter(
                    "nuevaComuna");
            if (eivLocal.agregarComuna(nomComuna)) {
                servletRequest.setAttribute("mensaje",
                                            "La comuna fue ingresada exitosamente");
            } else {
                servletRequest.setAttribute("mensaje",
                                            "La comuna no pudo ser ingresada");
            }
            return adminComunas(actionMapping, servletRequest, httpsession);
        } catch (Exception ex) {
            ex.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo registrar la comuna");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward eliminarComuna(ActionMapping actionMapping,
                                         HttpServletRequest servletRequest,
                                         HttpSession httpsession) {
        try {
            EIVLocal eivLocal = LocalizadorServicios.getInstance().
                                getEIVLocal();
            Integer idComuna = Integer.valueOf(servletRequest.getParameter(
                    "idComuna"));
            if (eivLocal.eliminarComuna(idComuna)) {
                servletRequest.setAttribute("mensaje",
                                            "La comuna fue eliminada exitosamente");
            } else {
                servletRequest.setAttribute("mensaje",
            ...
            ex.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "La comuna no pudo ser eliminada");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward adminComunas(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest,
                                       HttpSession httpsession) {
        try {
            EIVLocal eivLocal = LocalizadorServicios.getInstance().
            ...
            ex.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la página de búsqueda de documentos");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward buscarDocOficio(ActionMapping actionMapping,
                                          HttpServletRequest servletRequest,
                                          HttpSession httpsession) {

        try {

            DocumentoLocal dl = LocalizadorServicios.getInstance().
                                getDocumentoLocal();
            BusDocsVO bus = new BusDocsVO();
            //indica q no se debe buscar en los documentos relacionados con las Iniciativas de Inversión
            ...
            if (servletRequest.getParameter("tipoBus").equals("2")) {
                bus.setIdSentido(new Integer(1)); //Indica q solamente debe buscar entre los documentos entrantes<1>
     ...
     * @return ActionForward
     */
    private ActionForward cargarBusDocOficio(ActionMapping actionMapping,
                                             HttpServletRequest
                                             servletRequest,
                                             HttpSession httpsession) {
        ...
        try {
            ...
            ex.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la página de búsqueda de oficios");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward agregarTipoEIV(ActionMapping actionMapping,
                                         HttpServletRequest servletRequest,
                                         HttpSession httpsession) {
        try {
            EIVLocal eivLocal = LocalizadorServicios.getInstance().
                                getEIVLocal();
            if (eivLocal.insertTipoEIV(servletRequest.getParameter(
                    "nuevotipo"))) {
                servletRequest.setAttribute("mensaje",
                                            "El nuevo tipo de EIV fue ingresado exitosamente");
                return cargaTiposEIV(actionMapping, servletRequest,
                                     httpsession);
            } else {
                servletRequest.setAttribute("mensaje",
                                            "No se pudo ingresar el tipo de EIV");
                return cargaTiposEIV(actionMapping, servletRequest,
                                     httpsession);
     ...
     * @return ActionForward
     */
    private ActionForward eliminarTipoEIV(ActionMapping actionMapping,
                                          HttpServletRequest servletRequest,
                                          HttpSession httpsession) {
        try {
            ...
            if (eivLocal.eliminarTipoEIV(idTipo)) {
                servletRequest.setAttribute("mensaje",
                                            "El tipo de EIV fue eliminado exitosamente");
                return cargaTiposEIV(actionMapping, servletRequest,
                                     httpsession);
            } else {
                servletRequest.setAttribute("mensaje", "No se pudo eliminar el tipo de EIV.Verifique que no existe ningún EIV de este tipo");
                return actionMapping.findForward("mensaje_fw");
            }
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @return ActionForward
     */
    private ActionForward aEnvioEmail(ActionMapping actionMapping,
                                      HttpServletRequest servletRequest,
                                      HttpSession httpsession) {
     ...
     * @return ActionForward
     */
    private ActionForward aDespachar(ActionMapping actionMapping,
                                     HttpServletRequest servletRequest,
                                     HttpSession httpsession) {
        ...
        try {
            ...
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la página de despachos");
            return actionMapping.findForward("mensaje_fw");
        }
    }
     ...
     * @return ActionForward
     */
    private ActionForward detEvento(ActionMapping actionMapping,
                                    HttpServletRequest servletRequest,
                                    HttpSession httpsession) {
        try {
            Integer idEvento = Integer.valueOf(servletRequest.getParameter(
            ...
            servletRequest.setAttribute("nomEIV",
                                        servletRequest.getParameter("nomEIV"));
            servletRequest.setAttribute("id_eiv",
                                        servletRequest.getParameter("id_eiv"));
     ...
     * @return ActionForward
     */
    private ActionForward aCorregirEvento(ActionMapping actionMapping,
                                          HttpServletRequest servletRequest,
                                          HttpSession httpsession) {
...
//-------------------------------------------------------------
    private ActionForward cargaTiposEIV(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest,
                                        HttpSession httpsession) {
        ...
        try {
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudieron cargar los tipos de EIV");
            return actionMapping.findForward("mensaje_fw");
...
//-------------------------------------------------------------
    private ActionForward detEIVyDetEventos(ActionMapping actionMapping,
                                            HttpServletRequest
                                            servletRequest,
                                            HttpSession httpsession) {
        try {
            EIVLocal eivloc = LocalizadorServicios.getInstance().getEIVLocal();
            Integer ideiv = Integer.valueOf(servletRequest.getParameter(
                    "id_eiv"));
            servletRequest.setAttribute("detalleeiv",
                                        eivloc.getDetalleEIV(ideiv));
...
//-----------------------------------------------------
//-------------------------------------------------------------
    private ActionForward detEIVyle(ActionMapping actionMapping,
                                    HttpServletRequest servletRequest,
                                    HttpSession httpsession) {
        try {
            EIVLocal eivloc = LocalizadorServicios.getInstance().getEIVLocal();
...
//-----------------------------------------------------
//-------------------------------------------------------------
    private ActionForward detEIVydetEventyflujos(ActionMapping
                                                 actionMapping,
                                                 HttpServletRequest
                                                 servletRequest,
                                                 HttpSession httpsession) {
...
//-----------------------------------------------------
//-------------------------------------------------------------
    private ActionForward aReingresar(ActionMapping actionMapping,
                                      HttpServletRequest
                                      servletRequest,
                                      HttpSession httpsession) {
        try {
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la pagina de reingreso de documentación");
            return actionMapping.findForward("mensaje_fw");
        }
    }
...
//-----------------------------------------------------
//-------------------------------------------------------------
    private ActionForward aAprobRech(ActionMapping actionMapping,
                                     HttpServletRequest
                                     servletRequest,
                                     HttpSession httpsession) {
        ...
        try {
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la pagina de aprobación o rechazo de EIV");
            return actionMapping.findForward("mensaje_fw");
        }
    }
