...
import proyecto_uoct.ventas.model.*;
...
//----------Ventas-------------
     ...
     */
    private ActionForward refrescaRegPago(ActionMapping actionMapping,
                                          HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            Integer idVta = Integer.valueOf(servletRequest.getParameter(
                    "idVenta"));

            Float uf = Float.valueOf(servletRequest.getParameter("nuevaUF").
                                     replace(',', '.'));
            servletRequest.setAttribute("uf", uf);
            servletRequest.setAttribute("venta",
                                        ventasLocal.detalleVta(idVta));
            return actionMapping.findForward("regFechaPago_fw");
        } catch (Exception e) {
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "Error al refrescar la información de la Venta");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward actualizarVta(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            cli.setIdCliente(Integer.valueOf(servletRequest.getParameter(
                    "idCli")));
            v.setCliente(cli);
            ...
            for (int i = 0; i < d.length; i++) {
                ...
                String idInf = d[i].substring(d[i].indexOf("--") + 2,
                                              d[i].indexOf("!!"));
            ...
            servletRequest.setAttribute("mensaje",
                                        "El proceso de venta fue actualizado exitosamente");
            return actionMapping.findForward("mensaje_fw");
        } catch (Exception e) {
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "El proceso de venta no pudo ser actualizado");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward aactualizarUF(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo actualizar el valor de la UF");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward actualizarUF(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            String ufS = (String) servletRequest.getParameter(
                    "uf");
            ...
            if (ventasLocal.actualizaUF(ufS2)) {
                servletRequest.setAttribute("mensaje",
                                            "El valor de la UF ha sido actualizado");
            } else {
                servletRequest.setAttribute("mensaje",
     ...
     * @return ActionForward
     */
    private ActionForward anularVenta(ActionMapping actionMapping,
                                      HttpServletRequest servletRequest, HttpSession httpSession) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            Integer idVta = Integer.valueOf(servletRequest.getParameter(
     ...
     * @return ActionForward
     */
    private ActionForward regFechaFinVenta(ActionMapping actionMapping,
                                           HttpServletRequest servletRequest,HttpSession httpSession) {
        ...
        try {
            ...
            if (s != null) {
                ...
                if (ventasLocal.regFechaFin(fecha, codFact,idVta)) {
                    ...
                    servletRequest.setAttribute("mensaje",
                                                "Error: La venta no fue actualizada");
                }
                return detalleVenta(actionMapping, servletRequest, httpSession);
            } else {
                servletRequest.setAttribute("venta",
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo registrar la fecha de entrega información vendida");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward regFechaEntregaInfo(ActionMapping actionMapping,
                                              HttpServletRequest servletRequest, HttpSession httpSession) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
     ...
     * @return ActionForward
     */
    private ActionForward regFechaPago(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest,HttpSession httpSession) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo registrar la fecha de pago");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward regFechaCotizacion(ActionMapping actionMapping,
                                             HttpServletRequest servletRequest,HttpSession httpSession) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo registrar la fecha de entrega de la cotización");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward editarVenta(ActionMapping actionMapping,
                                      HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la pag. de edición de ventas");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward buscarParaEditarVta(ActionMapping actionMapping,
                                              HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            if (servletRequest.getParameter("Submit") != null) {
                ...
                if (!("").equals(servletRequest.getParameter(
                        "fechaPresentacion")) &&
                    !("").equals(servletRequest.getParameter(
                            "fechaPresentacion2"))) {
                    bus.setFechaIni(sdf.parse(servletRequest.getParameter(
                            "fechaPresentacion")));
                    bus.setFechaIni2(sdf.parse(servletRequest.getParameter(
                            "fechaPresentacion2")));
                }
                if (!("").equals(servletRequest.getParameter("idCli"))) {
                    bus.setIdCli(Integer.valueOf(servletRequest.getParameter(
                            "idCli")));
                }

                if (!("0").equals(servletRequest.getParameter("idEstado"))) {
                    bus.setIdEstado(Integer.valueOf(servletRequest.getParameter(
                            "idEstado")));
                }

                servletRequest.setAttribute("ventas",
                                            ventasLocal.buscarVentas(bus));
            }
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la pag. de busqueda de ventas");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward detalleVenta(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest,
        ...
        try {
            ...
            boolean puedeEditar = usuarioLocal.tienePermiso(ds.getIdPerfil(),
                    "Editar Ventas");
            if (puedeEditar){
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la pag. de detalle de la venta");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward buscarVta(ActionMapping actionMapping,
                                    HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            if (servletRequest.getParameter("Submit") != null) {
                ...
                if (!("").equals(servletRequest.getParameter("palClave"))) {
                    bus.setPalClave(String.valueOf(servletRequest.getParameter(
                            "palClave")));
                }
     ...
     * @return ActionForward
     */
    private ActionForward regProcesoVta(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            if (ventasLocal.regProcesoVenta(v)) {
                ...
                eivLocal.alertaEmail("ventas@uoct.cl","x","jfanasco@uoct.cl","Cotización de Venta",cuerpoCorreo);
                ...
                servletRequest.setAttribute("mensaje",
                                            "El proceso de venta no pudo ser registrado");
            }
            return actionMapping.findForward("mensaje_fw");
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @return ActionForward
     */
    private ActionForward busCliVta_pop(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            if (servletRequest.getParameter("PorPalabra") != null) {
                servletRequest.setAttribute("clientes",
                                            ventasLocal.
                                            buscarClienteVta(servletRequest.
                        getParameter("palClave"), true));
            }
            return actionMapping.findForward("busCliVta_pop_fw");
        } catch (Exception e) {
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la pag. de busqueda de clientes");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward aRegProcesoVta(ActionMapping actionMapping,
                                         HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            servletRequest.setAttribute("tiposInfoVta",
                                        ventasLocal.getTiposInfo(true));
            return actionMapping.findForward("RegProcesoVta_fw");
        } catch (Exception e) {
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la pag. de registro de ventas");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward actualizarCliente(ActionMapping actionMapping,
                                            HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            cli.setTelefono(servletRequest.getParameter(
                    "fono_cli"));
            ...
            cli.setIsActivo(Integer.valueOf(servletRequest.getParameter(
                    "idEstado")));
     ...
     * @return ActionForward
     */
    private ActionForward editarCli(ActionMapping actionMapping,
                                    HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            servletRequest.setAttribute("cliente",
                                        ventasLocal.
                                        getDetalleCliente(Integer.
                    valueOf(servletRequest.getParameter("idCli"))));
    ...
    private ActionForward buscarparaEditarCli(ActionMapping actionMapping,
        ...
        try {
            ...
            if (servletRequest.getParameter("PorPalabra") != null) {
                servletRequest.setAttribute("clientes",
                                            ventasLocal.buscarClienteVta(
                        servletRequest.
                        getParameter("palClave"), false));
            }
     ...
     * @return ActionForward
     */
    private ActionForward exportarAgendaCli(ActionMapping actionMapping,
                                            HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            servletRequest.setAttribute("clientes",
                                        ventasLocal.exportarAgenda());
     ...
     * @return ActionForward
     */
    private ActionForward detalleCli(ActionMapping actionMapping,
                                     HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
     ...
     * @return ActionForward
     */
    private ActionForward buscarCliVta(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
     ...
     * @return ActionForward
     */
    private ActionForward RegistrarCli(ActionMapping actionMapping,
                                       HttpServletRequest servletRequest) {
     ...
     * @return ActionForward
     */
    private ActionForward actualizarInfoVta(ActionMapping actionMapping,
                                            HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            Integer id = Integer.valueOf(servletRequest.getParameter(
                    "idInfoVta"));
            String nom = servletRequest.getParameter("nom");
            String unidad = servletRequest.getParameter("unidad");
            Float precio = new Float(servletRequest.getParameter("precio1") +
                                     "." +
                                     servletRequest.getParameter("precio2"));
            ...
            if (ventasLocal.actualizarInfoVta(inf)) {
                servletRequest.setAttribute("mensaje",
                                            "La información para la venta fue actualizada");

            } else {
                servletRequest.setAttribute("mensaje",
                                            "No se pudo actualizar la información para la venta");
            }
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward editarInfoVta(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest) {
        ...
        try {
            ...
            servletRequest.setAttribute("detInfo",
                                        ventasLocal.getDetalleInfoVta(id));

            return actionMapping.findForward("editarTipoInfoVta_fw");
        } catch (Exception e) {
            e.printStackTrace();
            servletRequest.setAttribute("mensaje",
                                        "No se pudo cargar la pag. de edición de tipos de información para la venta");
            return actionMapping.findForward("mensaje_fw");
     ...
     * @return ActionForward
     */
    private ActionForward agregarInfoVta(ActionMapping actionMapping,
                                         HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            inf.setPrecio(new Float(servletRequest.getParameter("precio") + "." +
                                    servletRequest.getParameter("precio2")));
            if (ventasLocal.regInfoVta(inf)) {
                servletRequest.setAttribute("mensaje",
                                            "El tipo de de información fue registrada exitosamente");
            } else {
                servletRequest.setAttribute("mensaje",
                                            "No se pudo registrar el tipo de información para la venta");
            }
            return adminTiposVta(actionMapping, servletRequest);
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @return ActionForward
     */
    private ActionForward adminTiposVta(ActionMapping actionMapping,
                                        HttpServletRequest servletRequest) {
        try {
            VentasLocal ventasLocal = LocalizadorServicios.getInstance().
                                      getVentasLocal();
            ...
            e.printStackTrace();
            servletRequest.setAttribute("mensaje", "No se pudo cargar la pag. de administración de tipos de información para la venta");
            return actionMapping.findForward("mensaje_fw");
        }
    }
